...
/*
 * NavBar.java
 * This class is responsible for creating a navigation bar at the bottom of the screen.
 * It contains buttons for navigating to different sections of the application, such as Home, Leaderboard, User, and Settings.
 */
public class NavBar {
